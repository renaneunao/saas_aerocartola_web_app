...
(function () {
  ...
  function playerCard(player, position, index) {
    ...
    const badges = player?.eh_capitao ? `<span class="ideal-badge ideal-badge-captain" title="Capitão atual"><img class="ideal-cartola-role-icon" src="${CARTOLA_CAPTAIN_ICON}" alt="Ícone capitão"><b>CAP</b></span>` : '';
